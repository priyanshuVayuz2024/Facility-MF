...
export const BreadCrumbCustom = ({
    ...
    return (
        <>
            ...
            {/* Page Title */}
            <div
                className={`${buttons && "sticky top-[104px]"
                    } bg-[#F5F9FE] z-10 pb-3 flex flex-col sm:flex-row! sm:justify-between! sm:items-center! gap-4 sm:gap-0!`}
            >
            ...
            {description ? (
                <>
                    {buttons &&
                        <div className="w-full -mt-3 h-6 top-20 bg-[#F5F9FE] sticky z-5"></div>
                    }
                ...
                <div className="w-full h-6 top-20 bg-[#F5F9FE] sticky z-5"></div>
            )}
        </>
    );
};
